...
{
    public class PanelK : System.Windows.Forms.Panel
    {
        // cái này chơi chiêu vẽ thẳng lên màn hình
        //  vẽ chồng lên vạn vật (nhưng vẽ tạm thời thôi)
        //[DllImport("User32.dll")]
        //static extern IntPtr GetDC(IntPtr hwnd);

        //static void draw(Rectangle r, Brush b, IntPtr hwnd)// hwnd này truyền vào: GetDC(IntPtr.Zero)
        //{
        ...
        //// layer nền, sau khi quá số lần undo (số lượng layer giới hạn) thì gộp layer cuối vào layer này
        //private Bitmap layerBase;
        //// cái này dùng để vẽ vào bitmap
        ...
        public PanelK()
        {
            //SetStyle(System.Windows.Forms.ControlStyles.OptimizedDoubleBuffer | System.Windows.Forms.ControlStyles.ResizeRedraw, true);


            //Width = Properties.Settings.Default.panel_width;
            //Height = Properties.Settings.Default.panel_heigh;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle( new Pen(Brushes.Red,15), new Rectangle(10, 10, 200, 200));
        ...
        //            brushMain.Color = Color.FromArgb(20, brushMain.Color);
        ...
        //    rectTemp = this.DisplayRectangle;
        //    rectTemp.Width += 200;
        //    rectTemp.Height += 200;

        //    // Tạo một buffer với kích cỡ là bề mặt form;
        //    myBuffer = currentContext.Allocate(host.pnBackGround.CreateGraphics(),
        //    rectTemp);
        //    // Vẽ một ellipse
        //    myBuffer.Graphics.DrawEllipse(new Pen(brushMain,15), rectTemp);
        //    // Render nội dung
        //    myBuffer.Render();
        //    myBuffer.Dispose();
        ...
        public void GetImage(Image image)
        {
            ...
            gg.DrawImage(image, Point.Empty);
